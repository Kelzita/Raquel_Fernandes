...
//Inicializa variável par armazenar fornecedores
$fornecedores = [];

//Buscar todos os fornecedores cadastrados em ordem alfabética
...
//Se um id foi passado via get delete o Fornecedor
